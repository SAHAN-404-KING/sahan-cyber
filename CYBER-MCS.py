...
\033[1;37m----------------------------------------------
\033[92;1m>>   \033[1;37mOwner      :  Sahan
...
#menu_apikey()
os.system
(f'xdg-open {tan}:https://www.facebook.com/yt.sahan.x.ff')
logo=(f"""
...
def gml():
                ...
                clear()
                pcp.append(f'y')
                print('\033[1;32m Name  example:  Fariya, Rana, Sabbir, Forhad ')
                code = input(' First name : ')
                print(' Name Example : Jannat. Chowdhury, hossen, hossain')
